(define (problem sliterlink-638552) (:domain slitherlink)
(:init
  ...
  (cell-capacity cell-4-5 cap-3)
  (cell-capacity cell-4-6 cap-4)
  (cell-capacity cell-4-7 cap-4)
  (cell-capacity cell-4-8 cap-1)
