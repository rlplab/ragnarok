...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0000) (guarded location-0003) (guarded location-0010) (guarded location-0013) (guarded location-0014) (guarded location-0027) (guarded location-0034) (guarded location-0035) (guarded location-0036) (guarded location-0048) (guarded location-0050) (guarded location-0051) (guarded location-0052) (guarded location-0053))
