...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0005) (guarded location-0008) (guarded location-0011) (guarded location-0012) (guarded location-0014) (guarded location-0048) (guarded location-0058) (guarded location-0059) (guarded location-0060))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0000) (guarded location-0007) (guarded location-0023) (guarded location-0025) (guarded location-0030) (guarded location-0031) (guarded location-0032) (guarded location-0034) (guarded location-0037))
