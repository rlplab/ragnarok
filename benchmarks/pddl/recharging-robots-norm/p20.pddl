(define (problem recharging-robots-cover-robots5-areas3-1373-7695) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0025 location-0032)
  (connected location-0024 location-0033)
  ...
  (connected location-0025 location-0054)
  ...
  (connected location-0018 location-0060)
  (connected location-0008 location-0034)
  ...
  (connected location-0028 location-0048)
  (connected location-0002 location-0029)
  (connected location-0019 location-0045)
  ...
  (connected location-0010 location-0037)
  ...
  (connected location-0023 location-0037)
  (connected location-0006 location-0051)
  ...
  (connected location-0022 location-0034)
  ...
  (connected location-0020 location-0055)
  (connected location-0010 location-0032)
  (connected location-0002 location-0028)
  (connected location-0030 location-0044)
  (connected location-0000 location-0040)
  ...
  (connected location-0016 location-0061)
  (connected location-0017 location-0026)
  (connected location-0036 location-0039)
  (connected location-0014 location-0036)
  (connected location-0028 location-0035)
  (connected location-0022 location-0049)
  (connected location-0043 location-0044)
  (connected location-0052 location-0056)
  ...
  (connected location-0023 location-0032)
  (connected location-0014 location-0029)
  (connected location-0004 location-0046)
  ...
  (at robot-00 location-0018)
  (battery robot-00 battery-0005)
  (at robot-01 location-0060)
  (battery robot-01 battery-0004)
  (at robot-02 location-0026)
  (battery robot-02 battery-0001)
  (at robot-03 location-0007)
  (battery robot-03 battery-0032)
  (at robot-04 location-0061)
  (battery robot-04 battery-0001)
  ...
  (guard-config config-00 location-0054)
  (guard-config config-00 location-0055)
  (guard-config config-00 location-0056)
  (guard-config config-00 location-0057)
  ...
  (guard-config config-01 location-0015)
  (guard-config config-01 location-0019)
  (guard-config config-01 location-0020)
  ...
  (guard-config config-01 location-0043)
  (guard-config config-01 location-0044)
  (guard-config config-01 location-0045)
  (guard-config config-01 location-0050)
  (guard-config config-02 location-0000)
  (guard-config config-02 location-0001)
  (guard-config config-02 location-0002)
  (guard-config config-02 location-0004)
  (guard-config config-02 location-0005)
  (guard-config config-02 location-0008)
  (guard-config config-02 location-0010)
  (guard-config config-02 location-0011)
  (guard-config config-02 location-0013)
  (guard-config config-02 location-0014)
  (guard-config config-02 location-0016)
  (guard-config config-02 location-0020)
  (guard-config config-02 location-0021)
  (guard-config config-02 location-0022)
  (guard-config config-02 location-0023)
  ...
  (guard-config config-02 location-0034)
  (guard-config config-02 location-0035)
  (guard-config config-02 location-0036)
  (guard-config config-02 location-0037)
  (guard-config config-02 location-0038)
  (guard-config config-02 location-0039)
  (guard-config config-02 location-0040)
  (guard-config config-02 location-0046)
  (guard-config config-02 location-0048)
  (guard-config config-02 location-0049)
  (guard-config config-02 location-0058)
)
