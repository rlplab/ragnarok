...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0000) (guarded location-0004) (guarded location-0005) (guarded location-0007) (guarded location-0010) (guarded location-0012) (guarded location-0016) (guarded location-0019) (guarded location-0026) (guarded location-0028) (guarded location-0029) (guarded location-0030) (guarded location-0031) (guarded location-0032) (guarded location-0033) (guarded location-0039) (guarded location-0040) (guarded location-0042) (guarded location-0054) (guarded location-0056) (guarded location-0057))
