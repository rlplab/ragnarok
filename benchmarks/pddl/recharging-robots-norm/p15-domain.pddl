...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0000) (guarded location-0002) (guarded location-0005) (guarded location-0006) (guarded location-0008) (guarded location-0010) (guarded location-0014) (guarded location-0024) (guarded location-0028) (guarded location-0046) (guarded location-0047) (guarded location-0049))
