...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0001) (guarded location-0002) (guarded location-0003) (guarded location-0005) (guarded location-0006) (guarded location-0008) (guarded location-0009) (guarded location-0014) (guarded location-0018) (guarded location-0032) (guarded location-0035) (guarded location-0036) (guarded location-0037) (guarded location-0038) (guarded location-0039) (guarded location-0040) (guarded location-0042) (guarded location-0044) (guarded location-0045))
