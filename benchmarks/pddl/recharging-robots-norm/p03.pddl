(define (problem recharge-single-source-move-to-locations-1742) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0014 location-0031)
  ...
  (connected location-0027 location-0036)
  ...
  (connected location-0006 location-0031)
  (connected location-0020 location-0030)
  (connected location-0003 location-0023)
  (connected location-0014 location-0032)
  (connected location-0013 location-0018)
  ...
  (connected location-0008 location-0033)
  ...
  (connected location-0000 location-0033)
  ...
  (at robot-00 location-0011)
  (battery robot-00 battery-0002)
  (at robot-01 location-0011)
  (battery robot-01 battery-0017)
  (at robot-02 location-0011)
  (battery robot-02 battery-0003)
  (at robot-03 location-0011)
  (battery robot-03 battery-0000)
  (at robot-04 location-0011)
  (battery robot-04 battery-0000)
  (at robot-05 location-0011)
  (battery robot-05 battery-0000)
)
(:goal (and (at robot-00 location-0034) (at robot-01 location-0023) (at robot-02 location-0027) (at robot-03 location-0009) (at robot-04 location-0004) (at robot-05 location-0028)))
