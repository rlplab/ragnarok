(define (problem recharge-single-source-move-to-locations-1856) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
...
(:goal (and (at robot-00 location-0016) (at robot-01 location-0011) (at robot-02 location-0027) (at robot-03 location-0038) (at robot-04 location-0017)))
