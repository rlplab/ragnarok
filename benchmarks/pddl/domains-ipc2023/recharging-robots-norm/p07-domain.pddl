...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0002) (guarded location-0009) (guarded location-0014) (guarded location-0032) (guarded location-0033) (guarded location-0035))
