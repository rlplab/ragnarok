...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0003) (guarded location-0015) (guarded location-0019) (guarded location-0021) (guarded location-0024) (guarded location-0036) (guarded location-0043) (guarded location-0054) (guarded location-0056) (guarded location-0057))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0003) (guarded location-0004) (guarded location-0007) (guarded location-0015) (guarded location-0017) (guarded location-0019) (guarded location-0021) (guarded location-0054) (guarded location-0055) (guarded location-0056))
