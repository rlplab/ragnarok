...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0002) (guarded location-0003) (guarded location-0004) (guarded location-0006) (guarded location-0008) (guarded location-0014) (guarded location-0022) (guarded location-0023) (guarded location-0024) (guarded location-0025) (guarded location-0026))
