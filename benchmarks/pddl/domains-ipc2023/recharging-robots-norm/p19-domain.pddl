...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0004) (guarded location-0005) (guarded location-0006) (guarded location-0008) (guarded location-0011) (guarded location-0012) (guarded location-0015) (guarded location-0016) (guarded location-0018) (guarded location-0020) (guarded location-0021) (guarded location-0025) (guarded location-0026) (guarded location-0027) (guarded location-0028) (guarded location-0029) (guarded location-0030) (guarded location-0031) (guarded location-0032) (guarded location-0033) (guarded location-0038) (guarded location-0058) (guarded location-0059) (guarded location-0061))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0001) (guarded location-0003) (guarded location-0004) (guarded location-0007) (guarded location-0009) (guarded location-0010) (guarded location-0013) (guarded location-0014) (guarded location-0017) (guarded location-0019) (guarded location-0022) (guarded location-0023) (guarded location-0024) (guarded location-0025) (guarded location-0029) (guarded location-0039) (guarded location-0040) (guarded location-0042) (guarded location-0043) (guarded location-0044) (guarded location-0046) (guarded location-0047) (guarded location-0048) (guarded location-0049) (guarded location-0053))
