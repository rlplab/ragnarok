(define (problem sliterlink-249538) (:domain slitherlink)
(:init
  ...
  (cell-edge cell-0-8 cell-outside-0-right n-0-9 n-1-9)
  (cell-edge cell-outside-1-left cell-1-0 n-1-0 n-2-0)
  (cell-edge cell-1-8 cell-outside-1-right n-1-9 n-2-9)
  (cell-edge cell-outside-2-left cell-2-0 n-2-0 n-3-0)
  (cell-edge cell-2-8 cell-outside-2-right n-2-9 n-3-9)
  (cell-edge cell-outside-3-left cell-3-0 n-3-0 n-4-0)
  (cell-edge cell-3-8 cell-outside-3-right n-3-9 n-4-9)
  (cell-edge cell-outside-4-left cell-4-0 n-4-0 n-5-0)
  (cell-edge cell-4-8 cell-outside-4-right n-4-9 n-5-9)
  (cell-edge cell-outside-5-left cell-5-0 n-5-0 n-6-0)
  (cell-edge cell-5-8 cell-outside-5-right n-5-9 n-6-9)
  (cell-edge cell-outside-6-left cell-6-0 n-6-0 n-7-0)
  (cell-edge cell-6-8 cell-outside-6-right n-6-9 n-7-9)
  (cell-edge cell-outside-7-left cell-7-0 n-7-0 n-8-0)
  (cell-edge cell-7-8 cell-outside-7-right n-7-9 n-8-9)
  (cell-edge cell-outside-8-left cell-8-0 n-8-0 n-9-0)
  (cell-edge cell-8-8 cell-outside-8-right n-8-9 n-9-9)
